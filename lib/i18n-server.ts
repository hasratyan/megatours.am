...
import { defaultLocale, type Locale, type Translation } from "@/lib/i18n";
  ...
  hy: {
    ...
    search: {
      ...
      errors: {
        ...
        submit: "Հյուրանոցների որոնումը ժամանակավորապես անհասանելի է։ Խնդրում ենք կրկին փորձել։",
      },
    },
    services: {
  ...
  common: {
    ...
    hotel: {
      ...
      roomOptions: {
        ...
        roomBundleTitle: "{count} սենյակի տարբերակ",
        forRooms: "{count} սենյակի համար",
        mealPlans: {
        ...
        roomBreakdown: "Սենյակ {index}: {name} — {price}",
  ...
  en: {
    ...
    search: {
      ...
      errors: {
        ...
        submit: "Hotel search is temporarily unavailable. Please try again.",
      },
    },
    services: {
  ...
  common: {
    ...
    hotel: {
      ...
      roomOptions: {
        ...
        roomBreakdown: "Room {index}: {name} — {price}",
  ...
  ru: {
    ...
    search: {
      ...
      errors: {
        ...
        submit: "Поиск отелей временно недоступен. Пожалуйста, попробуйте еще раз.",
      },
    },
    services: {
  ...
  common: {
    ...
    hotel: {
      ...
      roomOptions: {
        ...
        roomBreakdown: "Номер {index}: {name} — {price}",
